...
# ## **Thanks for** :https://www.kaggle.com/chumajin/optiver-realized-ensamble-tabnet-and-lgbm
...
path = "../input/optivertabnetmodels"

for fold in range(5):
    get_ipython().system('cp -r ../input/optivertabnetmodels/tabnet_model_test_{str(fold)}/* .')
