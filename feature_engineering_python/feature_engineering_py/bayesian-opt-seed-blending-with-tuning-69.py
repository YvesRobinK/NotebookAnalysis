...
# # Acknowledgements
# 
# - Original kernel by: https://www.kaggle.com/irochka/bayesian-opt-seed-blending-with-tuning
# - changes: seed to 69
# - kept re-running kernel in hopes of improved score
...
# 
# with my tuning (outher parameters).
# 
# 
