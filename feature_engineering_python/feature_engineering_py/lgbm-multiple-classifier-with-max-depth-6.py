...
# My experience (for example [Titanic (0.83253) - Comparison 20 popular models](https://www.kaggle.com/vbmokin/titanic-0-83253-comparison-20-popular-models)) has shown that simulation using LGBMClassifier is better if you set both parameter num_leaves and parameter max_depth

# In[22]:


params = {'num_leaves': 45, 'max_depth': 6, # 2**6 = 64 - Let's set 45 to prevent overfitting
