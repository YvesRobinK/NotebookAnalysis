...
# Credit to this Kernel from Scirpus - https://www.kaggle.com/scirpus/hybrid-gp-and-nn
# Credit to this Kernel from Prashant - https://www.kaggle.com/prashantkikani/nfl-starter-mlp-feature-engg
# Tried my luck and getting around 0.1369. 
...
def create_features(df, deploy=False):
    ...
    def static_features(df):
        ...
        'YardLine','Quarter','Down','Distance','DefendersInTheBox','JerseyNumber','PlayerHeight','PlayerWeight','PossessionTeam','FieldPosition','PlayDirection','Team','TimeHandoff','TimeSnap','PlayerBirthDate']].drop_duplicates()
...
train_basetable['Field_eq_Possession'] = np.where(train_basetable['Field_eq_Possession']=='True',1,0)
train_basetable['PlayDirection'] = np.where(train_basetable['PlayDirection']=='True',1,0)
...
model.add(Dropout(0.6)) #dropout is a type of regularisation. Regularisation helps to control overfitting
...
for (test_df, sample_prediction_df) in iter_test:
    ...
    basetable['Field_eq_Possession'] = np.where(basetable['Field_eq_Possession']=='True',1,0)
    basetable['PlayDirection'] = np.where(basetable['PlayDirection']=='True',1,0)
