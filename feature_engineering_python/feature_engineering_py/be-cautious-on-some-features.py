...
# # What's this kernel?
# 
# This kernel is to explain the potential **risk** to use some of the features commonly used in those high score kernels: https://www.kaggle.com/artgor/oop-approach-to-fe-and-models , https://www.kaggle.com/ragnar123/feature-engineering-v-1-0 , https://www.kaggle.com/shivyshiv/ensemble-of-xgboost-and-lgbm
# 
# Belows are the feature engineering part of the kernel https://www.kaggle.com/ragnar123/feature-engineering-v-1-0 .
...
# ## Problematic part
# 
# In this part, some features are added by extracting some stats of exsiting features with regard to `installation_id`.  
# This part contains **two big issues.**
# 
# 1. For some of the samples in the DataFrame, this preprocess will give **future information.**
# 2. The **distribution** of the features added in this part **are totally different between train and test.**
...
# Let's see how the distribution of these features different

# In[10]:


reduce_train["installation_session_count"].plot.hist(bins=100);


# In[11]:


reduce_test["installation_session_count"].plot.hist(bins=100);


# In[12]:


reduce_train["installation_title_nunique"].plot.hist(bins=100);


# In[13]:


reduce_test["installation_title_nunique"].plot.hist(bins=100);


# The reason is simple. Test DataFrame only contains **one sample for an installation_id** while train DataFrame contains some samples for an installation_id.
# 
# Those features that use `mean` operation to aggregate do not differ so much, but yet they are using future information in train DataFrame.
