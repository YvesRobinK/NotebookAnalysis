...
# 2. <font size="3">Serum creatinine looks like distingushing feature atleast in the train dataset</font>
...
# <font size="3">Let's also take the best notebooks at the top compute porbabilistic averages after scaling. This will be combined with the above model predictions</font>
...
# * Notebook by [@alexryzhkov](https://www.kaggle.com/code/alexryzhkov/lb-0-88048-simple-smoking-ensemble)
...
sub_combined['smoking']=(3*sub1['smoking'] + 2*sub2['smoking'] + 1*sub["smoking"]+1/2*sub3["smoking"]
                         +1/4*sub4["smoking"]+1/8*sub5["smoking"]+1/16*sub6["smoking"]) 
