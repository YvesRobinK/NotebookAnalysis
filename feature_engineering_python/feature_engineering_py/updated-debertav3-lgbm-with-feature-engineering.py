...
# ![undraw_Knowledge_re_5v9l.png](attachment:8f4bccdc-0008-4cd9-ad17-93f7029ec550.png)
# 
# ## Main Concept
# 
...
# 図のような構成のモデルを作成する。
# 
# ![image.png](attachment:d3307037-fd37-4c8f-be6b-28da06e76525.png)
# 
...
# 
# 
# 今回、CVの値は多少改善され、LBも改善した。
# この結果から、特徴量エンジニアリングをした結果をGBDT系で組み合わせる手法の筋は悪くなさそうに思えた。
# 
# In this time, the CV mcrmse score looks a little better.
# LB also got a little better.
# 
# Based on these results, the method of combining the GBDT　with NLP feature　seems not so bad.
# 
