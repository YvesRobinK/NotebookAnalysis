...
# ## Evaluate Model
# 
# todo: tune / try different layer architectures
...
model = TabularModel(
    emb_szs={}, 
    n_cont=len(features) + 15, # 15 added in the batch
...
get_ipython().run_cell_magic('time', '', 'fit = learn.fit(2 if DEBUG else 25, 1e-3)\n')
