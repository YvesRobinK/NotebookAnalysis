...
data['Survived'].value_counts().plot.pie(explode=[0,0.01],autopct='%1.1f%%',ax=ax[0],shadow=True)
ax[0].set_title("Survived")
ax[0].legend()
sns.countplot("Survived",data=data,ax=ax[1],facecolor=(0, 0, 0, 0),linewidth=5,edgecolor=sns.color_palette("dark", 3))
...
f,ax = plt.subplots(1,2,figsize=(18,8))
data['Pclass'].value_counts().plot.bar(ax=ax[1])
ax[1].set_title('Number Of Passengers By Pclass')
ax[1].set_ylabel('Count')
sns.countplot(y='Pclass',hue='Survived',data=data,ax=ax[0])
...
print('Titanic Miximum Age:',data['Age'].max(),'Years')
print('Titanic Minimum Age:',data['Age'].min(),'Years')
print('Titanic Average Age:',data['Age'].mean(),'Years')
...
sns.violinplot("Sex","Age", hue="Survived", data=data,split=True,ax=ax[1],inner='stick')
...
# 1) For python:[Cancer-benign/malignant. (SVM )](https://www.kaggle.com/zohaib123/cancer-benign-malignant-svm)
# 
# 2)For Python:[Tv Marketing Prediction](https://www.kaggle.com/zohaib123/tv-marketing-prediction)
# 
# 3)For Python:[Perform EDA Beginner's Guide(Titanic)](https://www.kaggle.com/zohaib123/perform-eda-beginner-s-guide-titanic)
# 
# ### Thanks a lot for having a look at this notebook. If you found this notebook useful, **Do Upvote**.
# 

# Copy and edit from Ashwini Swain
