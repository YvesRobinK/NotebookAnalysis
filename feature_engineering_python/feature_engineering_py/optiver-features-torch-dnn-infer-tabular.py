...
# 
# **INFERENCE for https://www.kaggle.com/code/jirkaborovec/optiver-gpu-speedsup-feature-eng-torch-dnn**
# 
...
get_ipython().system('pip install -q "pandas<2.0.0" -f /kaggle/input/pytorch-tabular-python-package/ --no-index')
...
get_ipython().system('pip install -U -q pytorch_tabular torch_optimizer -f /kaggle/input/pytorch-tabular-python-package/ --no-index --pre')
# !pip install -U -q https://github.com/Lightning-Sandbox/pytorch_tabular/archive/refs/heads/kaggle.zip
...
# PATH_LOAD_MODELS = '/kaggle/input/optiver-gpu-speedsup-feature-eng-torch-dnn'  # Directory to save models
PATH_LOAD_MODELS = '/kaggle/input/optiver-trading-at-close-submissions/tabular-models'  # Directory to save models
#os.makedirs(model_save_path, exist_ok=True)

ls_models = sorted(glob.glob(os.path.join(PATH_LOAD_MODELS, "tabular-*")))
print(f"found {len(ls_models)} models")
models = [TabularModel.load_model(model_dir) for model_dir in ls_models]
