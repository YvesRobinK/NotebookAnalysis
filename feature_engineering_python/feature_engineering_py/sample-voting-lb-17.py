...
get_ipython().run_line_magic('pinfo', 'xgb.XGBRegressor')
...
LB_1_091 = pd.read_csv("/kaggle/input/k/songqizhou/seasonal-model-with-validation-lb-1-091/submission.csv")
LB_1_0862 = pd.read_csv("/kaggle/input/voting-1-0862-5-jan-2023/submission.csv")

test['microbusiness_density'] = test['cfips'].map(dt) #+ 0.2*LB_1_091["microbusiness_density"]

test[['row_id','microbusiness_density']].to_csv('submission_1.csv', index=False)
test.head(40)
...
LB_1_086 = pd.read_csv("submission_1.csv")


# In[37]:


LB_1_086["microbusiness_density"] = 0.1*LB_1_086["microbusiness_density"] + 0.05*LB_1_091["microbusiness_density"]+ 0.85*LB_1_0862["microbusiness_density"]


# In[38]:


LB_1_086.to_csv('submission.csv', index=False)
...
np.corrcoef(LB_1_086["microbusiness_density"],LB_1_091['microbusiness_density'])


# In[41]:


#LB_1_086["microbusiness_density"]


# In[42]:


#LB_1_091["microbusiness_density"]
