...
get_ipython().run_cell_magic('time', '', "m = Prophet(yearly_seasonality=True, weekly_seasonality=True, daily_seasonality=True)\nm.fit(train_df[['ds','y']]);\n")
...
get_ipython().run_cell_magic('time', '', 'forecast = m.predict(future)\nforecast.tail(n=3)\n')
...
get_ipython().run_cell_magic('time', '', "m_holi = Prophet(yearly_seasonality=True, weekly_seasonality=True, daily_seasonality=True, holidays=holidays)\nm_holi.fit(train_df[['ds','y']]);\n")
...
get_ipython().run_cell_magic('time', '', 'forecast_holi = m_holi.predict(future_holi)\nforecast_holi.tail(n=3)\n')
...
get_ipython().run_cell_magic('time', '', "m2 = Prophet(yearly_seasonality=True, weekly_seasonality=True, daily_seasonality=True)\nm2.fit(train_df2[['ds','y']]);\n")
