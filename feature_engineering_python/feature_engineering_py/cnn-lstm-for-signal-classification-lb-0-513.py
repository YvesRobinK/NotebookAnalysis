...
get_ipython().run_cell_magic('time', '', 'x = high_pass(train_set.iloc[:,p1])\nX = fftpack.fft(x,n=400)\nfreqs = fftpack.fftfreq(n=400,d=2e-2/x.size) \n')
...
get_ipython().run_cell_magic('time', '', 'x = low_pass(signal)\nX = fftpack.fft(x,n=400)\nfreqs = fftpack.fftfreq(n=400,d=2e-2/x.size) \n')
