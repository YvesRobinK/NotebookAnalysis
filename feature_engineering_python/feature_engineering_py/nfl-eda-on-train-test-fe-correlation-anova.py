...
train_df['TimeHandoff'].hist(bins=100, figsize=(13, 4),\
                             label='train', xrot=45)
...
uniq_cols = ['PossessionTeam', 'OffenseFormation', 'OffensePersonnel',\
             ...
             'Humidity', 'FieldPosition_std', 'PlayId']


# In[15]:


X_train = train_df[uniq_cols+['Yards']]\
