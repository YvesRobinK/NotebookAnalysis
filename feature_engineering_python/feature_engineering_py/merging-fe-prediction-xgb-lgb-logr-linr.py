...
feature_score['merging'] = w_lgb*feature_score['score_lgb'] + w_xgb*feature_score['score_xgb'] \
                       + w_logreg*feature_score['score_logreg'] + w_linreg*feature_score['score_linreg']
