...
# ### What's GroupKFold?
# 
# From the [documentation](https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GroupKFold.html):
# > K-fold iterator variant with non-overlapping groups.
# 
# Here, the groups are going to be the molecules. The result will be that no molecule appears in two different folds - this more closely resembles the final submission setting than shuffled kfold cross-validation.
# 
# Here, I take the excellent notebook "Distance is all you need" ([link](https://www.kaggle.com/criskiev/distance-is-all-you-need-lb-1-481)), replace KFold with GroupKFold crossvalidation, and let the models train for longer.
# 
# Criskiev's notebook (linked above) really is excellent, so please remember to upvote it!
