...
# 
# - Original kernel by https://www.kaggle.com/braquino/convert-to-regression
# - **Objective** of this kernel is to illustrate the range of public LB scores with repeated submissions **only**
# - For possibly higher LB scores with this kernel, you may want to consider using the kernel's parameters from https://www.kaggle.com/ilyasniyazov/lgb-model and incorporating it here
