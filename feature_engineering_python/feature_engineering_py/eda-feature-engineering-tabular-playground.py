...
# ## Sequence feature has uniform distribution
...
# ## Sensor_02 has a Bernoulli distribution.
...
def sensor_train_test_distribution(df_train, df_test, figsize=(16, 32)):
    ...
    for index, col in enumerate(sensor_cols):
        ...
        axes[index].text(0.95, 0.9,'smape:'+str(round(smape_score, 2)), horizontalalignment
='center', 
...
# ## Sensor_02, 01, 04, 12 are a better fit with the test set and, Sensor_10 is the worst fit with the test set
