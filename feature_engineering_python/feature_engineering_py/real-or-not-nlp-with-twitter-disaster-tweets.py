...
# **<span style="color:blue">Please Upvote If You Like, Use Or Learn From This. If you have any idea that might improve this kernel, please be sure to comment, or fork and experiment as you like. If you don't understand any part, feel free to ask in the comment section.**🙌🙌🙌
...
# The top 3 locations with highest % of disaster tweets are **Mumbai, India, and Nigeria**. As the location data is not clean, we see some interesting cases, such as **'London, UK' saw a higher-than-average % of disaster tweets, but 'London' is below average**. We try to clean up the location and see if there is any difference:
...
submit.to_csv('submisson1.csv',index=False)
