...
# test['microbusiness_density'] = 0.5*test['microbusiness_density'] + 0.5*sub['microbusiness_density']
...
sub = pd.read_csv("/kaggle/input/godaddyxgb/submission.csv")
for i, row in sub.iterrows():
    test.iat[i,1] = (
        0.55*test.iat[i,1] +
        0.45*row["microbusiness_density"]
    )
